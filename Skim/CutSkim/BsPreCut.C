...
void BsPreCut(int doMC){
	...
	*/
	...
	if(doMC == 0) 	fout = new TFile("BsDataPreCut.root","RECREATE");
	if(doMC == 1) 	fout = new TFile("BsMCPreCut.root","RECREATE");
