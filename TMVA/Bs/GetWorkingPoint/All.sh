i=0
N=9
ptmin=(1 2 3 5 7 10 15 20 30)
ptmax=(2 3 5 7 10 15 20 30 50)
...
MergedB="/data/szhaozho/ppNewTMVA/CMSSW_10_3_2/src/Bs/SamplesNew/BsDataAllBDT.root"
MergedS="/data/szhaozho/ppNewTMVA/CMSSW_10_3_2/src/Bs/SamplesNew/BsMCAllBDT.root"
...
#CUT="TMath::Abs(Bmumumass-3.096916)<0.15&&TMath::Abs(Btktkmass-0.892) < 0.12"

CUT="TMath::Abs(Bmumumass-3.096916)<0.15&&TMath::Abs(Btktkmass-1.019455)<0.015"
...
MYCUTG=("(abs(Gy)<2.4&&abs(GpdgId)==531&&GisSignal>0)");
