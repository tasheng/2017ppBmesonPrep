...
Double_t norm = 0.401; // FF of b->B+, i.e., D fraction
...
//	Float_t nB = hMassD->Integral()*dmassDsignal/(dmassDsidbandH-dmassDsidbandL);
		...
		cout << "nB Before Bro: = " << nB << endl;
		
	nB = hMassD->Integral()/((massDsidebandRH - massDsidebandRL) + (massDsidebandLH - massDsidebandLL))*(massDsignalH- massDsignalL);
		cout << "nB After Bro: = " << nB << endl;
	...
	cout << "Inside Fucked: " << "  ptmin = " << ptmax << "  ptmax = " << ptmax << endl;
