...
#inputs="/data/szhaozho/FinalGitHub/2017ppBmesonAna/UnskimmedSamples/OfficialMC/BPMC.root"
#inputb="/data/szhaozho/2017ppSamples/UnSkimmed//BPData.root"

inputb="/data/szhaozho/2017ppSamples/UnSkimmed//BPData.root"
inputs="/data/szhaozho/2017ppSamplesFinal/Unskimmed/BPMC.root"
...
stages="14,18,19,20,21,22"

#stages="14,2,3,4,5,6,7"
...
varlist=(
	'# 1:  ("BDT_pt_3_5", "BDT_pt_3_5"                                                                                 , "FMin")  #'			
	'# 2:  ("BDT_pt_5_7", "BDT_pt_5_7"                                                                                 , "FMin")  #'		
    '# 3:  ("BDT_pt_7_10", "BDT_pt_7_10"                                                                                 , "FMin")  #'		
    '# 4:  ("BDT_pt_10_15", "BDT_pt_10_15"                                                                                 , "FMin")  #'		
    '# 5:  ("BDT_pt_15_20", "BDT_pt_15_20"                                                                                 , "FMin")  #'	
    '# 6:  ("BDT_pt_20_50", "BDT_pt_20_50"                                                                                 , "FMin")  #'		   
	'# 7:  ("Bmass", "Bmass"                                                                                 , "FMin")  #'		
)
