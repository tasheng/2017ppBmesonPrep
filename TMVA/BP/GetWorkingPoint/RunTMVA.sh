...
MergedB="/data/szhaozho/Bmeson2017pp/${mvatype}Output/BP_Data_${mvatype}_Merged_pt_${ptmin}_${ptmax}.root"
MergedS="/data/szhaozho/Bmeson2017pp/${mvatype}Output/BP_MC_${mvatype}_Merged_pt_${ptmin}_${ptmax}.root"
...
OUTPUTNAME="BP_${mvatype}_Training_${ptmin}_${ptmax}"
